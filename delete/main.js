...
function getSelect() {
    FullSelect('#id_good_update', 'tb_goods');
    FullSelect('#id_good_create', 'tb_delete_goods');
    FullSelect('#id_good_delete', 'tb_delete_goods');
    FullSelect('#id_sub_dept_update', 'tb_delete_goods');
    FullSelect('#id_sub_dept_create', 'tb_delete_goods');
    FullSelect('#id_sub_dept_delete', 'tb_delete_goods');
}
...
function setDatosModal(d) {
    $('#id_delete_update').val(d[0]['id_delete']);
    $('#id_good_update').val(d[0]['id_good']);
    $('#date_of_deletion_update').val(d[0]['date_of_deletion']);
    $('#id_sub_dept_update').val(d[0]['id_sub_dept']);
    $('#value_deleted_good_update').val(d[0]['value_deleted_good']);
    $('#modal_update').modal();
}
...
function _update() {
    var datos = {
        id_delete: $('#id_delete_update').val(),
        id_good: $('#id_good_update').val(),
        date_of_deletion: $('#date_of_deletion_update').val(),
        id_sub_dept: $('#id_sub_dept_update').val(),
        value_deleted_good: $('#value_deleted_good_update').val()
    };
...
function _create() {
    var datos = {
        id_good: $('#id_good_create').val(),
        date_of_deletion: $('#date_of_deletion_create').val(),
        id_sub_dept: $('#id_sub_dept_create').val(),
        value_deleted_good: $('#value_deleted_good_create').val()
    };
...
function setMensajeModal(d) {
    $('#id_delete_delete').val(d[0]['id_delete']);
    $('#id_good_delete').val(d[0]['id_good']);
    $('#date_of_deletion_delete').val(d[0]['date_of_deletion']);
    $('#id_sub_dept_delete').val(d[0]['id_sub_dept']);
    $('#value_deleted_good_delete').val(d[0]['value_deleted_good']);
    $('#modal_delete').modal();
    idDel = d[0]['id_delete'];
