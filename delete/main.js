$(document).ready(function () {
            ...
            FullSelect('#id_good_update', 'tb_delete_goods');FullSelect('#id_good_create', 'tb_delete_goods');FullSelect('#id_good_delete', 'tb_delete_goods');FullSelect('#id_sub_dept_update', 'tb_delete_goods');FullSelect('#id_sub_dept_create', 'tb_delete_goods');FullSelect('#id_sub_dept_delete', 'tb_delete_goods');
        }function get() {
            ...
            array.forEach(element => {
                ...
                function seleccionarSelect(nameselect, valor) {
                    ...
                    $('#tb_delete_goods _update')[0].reset();
                    return false;
                }function _create() {
                    var datos = {
                    ...
                    $('#tb_delete_goods _create')[0].reset();
                    return false;
                }function deletex(id) {
                    var datos = {
                        id_delete: id
                ...
                var idDel = 0;function setMensajeModal(d) {
                    ...
                    $('#tb_delete_goods_delete')[0].reset();
                    return false;
