$(document).ready(function () {
                        ...
                        required:'Ingrese Name_update',
                    },image_update: {
                        required:'Ingrese Image_update',
                    },password_update: {
                        ...
                        required:'Ingrese Name_create',
                    },image_create: {
                        required:'Ingrese Image_create',
                    },password_create: {
                        ...
                        required:'Ingrese Name_delete',
                    },image_delete: {
                        required:'Ingrese Image_delete',
                    },password_delete: {
            ...
            array.forEach(element => {
                ...
                $(nameselect).append(o);
                    ...
                    $('#id_user_update').val(d[0]['id_user']);$('#user_update').val(d[0]['user']);$('#name_update').val(d[0]['name']);$('#image_update').val(d[0]['image']);$('#password_update').val(d[0]['password']);
                    $('#modal_update').modal();
                }
                ...
                function seleccionarSelect(nameselect, valor) {
                    ...
                    var datos = {
                        id_user: $('#id_user_update').val(),user: $('#user_update').val(),name: $('#name_update').val(),image: $('#image_update').val(),password: $('#password_update').val()
                    };
                    ...
                    var datos = {
                        user: $('#user_create').val(),name: $('#name_create').val(),image: $('#image_create').val(),password: $('#password_create').val()
                    };
                ...
                var idDel = 0;function setMensajeModal(d) {
                    $('#id_user_delete').val(d[0]['id_user']);$('#user_delete').val(d[0]['user']);$('#name_delete').val(d[0]['name']);$('#image_delete').val(d[0]['image']);$('#password_delete').val(d[0]['password']);
                    $('#modal_delete').modal();
                    idDel = d[0]['id_user'];
