$(document).ready(function () {
                    ...
                    );$('#tb_departaments_delete').validate(
                        {
                            language: 'es',
                            errorClass: 'invalid',
                            validClass: 'valid',
            ...
            FullSelect('#id_chief_update', 'tb_departaments');FullSelect('#id_chief_create', 'tb_departaments');FullSelect('#id_chief_delete', 'tb_departaments');
        }function get() {
            ...
            array.forEach(element => {
                ...
                function seleccionarSelect(nameselect, valor) {
                    ...
                    var datos = {
                        id_departament: $('#id_departament_update').val(),short_dept_name: $('#short_dept_name_update').val(),full_dept_name: $('#full_dept_name_update').val(),id_chief: $('#id_chief_update').val()
                    };
                    ...
                    $('#tb_departaments _update')[0].reset();
                    return false;
                }function _create() {
                    var datos = {
                        short_dept_name: $('#short_dept_name_create').val(),full_dept_name: $('#full_dept_name_create').val(),id_chief: $('#id_chief_create').val()
                    };
                    ...
                    $('#tb_departaments _create')[0].reset();
                    return false;
                }function deletex(id) {
                    var datos = {
                        id_departament: id
                ...
                var idDel = 0;function setMensajeModal(d) {
                    ...
                    $('#tb_departaments_delete')[0].reset();
                    return false;
