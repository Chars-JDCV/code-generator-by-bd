...
function getSelect() {
    FullSelect('#id_title_update', 'tb_chiefs');
    FullSelect('#id_title_create', 'tb_chiefs');
    FullSelect('#id_title_delete', 'tb_chiefs');
}
...
function setDatosModal(d) {
    $('#id_chief_update').val(d[0]['id_chief']);
    $('#id_title_update').val(d[0]['id_title']);
    $('#chief_name_update').val(d[0]['chief_name']);
    $('#modal_update').modal();
}
...
function _update() {
    var datos = {
        id_chief: $('#id_chief_update').val(),
        id_title: $('#id_title_update').val(),
        chief_name: $('#chief_name_update').val()
    };
...
function _create() {
    var datos = {
        id_title: $('#id_title_create').val(),
        chief_name: $('#chief_name_create').val()
    };
...
function setMensajeModal(d) {
    $('#id_chief_delete').val(d[0]['id_chief']);
    $('#id_title_delete').val(d[0]['id_title']);
    $('#chief_name_delete').val(d[0]['chief_name']);
    $('#modal_delete').modal();
    idDel = d[0]['id_chief'];
