$(document).ready(function () {
                        $('#tb_privilegios_update').validate(
                        {
                            language: 'es',
                            errorClass: 'invalid',
                            validClass: 'valid',
                        ...
                        required:'Ingrese Privilegio_update',
                    },
                            },
                            honkeyup: false,
                    ...
                    );$('#tb_privilegios_create').validate(
                        {
                            language: 'es',
                            errorClass: 'invalid',
                            validClass: 'valid',
                            ...
                            {
                                privilegio_create: {
                        required:'Ingrese Privilegio_create',
                    },
                            },
                            honkeyup: false,
                            submitHandler: function () {
                    ...
                    );$('#tb_privilegios_delete').validate(
                        {
                            language: 'es',
                            errorClass: 'invalid',
                            validClass: 'valid',
                        ...
                        required:'Ingrese Privilegio_delete',
                    },
                            },
                            honkeyup: false,
                            submitHandler: function () {
            ...
            array.forEach(element => {
                ...
                $(nameselect).append(o);
                    ...
                    $('#id_privilegio_update').val(d[0]['id_privilegio']);$('#privilegio_update').val(d[0]['privilegio']);
                    $('#modal_update').modal();
                }
                ...
                function seleccionarSelect(nameselect, valor) {
                    ...
                    var datos = {
                        id_privilegio: $('#id_privilegio_update').val(),privilegio: $('#privilegio_update').val()
                    };
                    ...
                    var datos = {
                        privilegio: $('#privilegio_create').val()
                    };
                ...
                var idDel = 0;function setMensajeModal(d) {
                    $('#id_privilegio_delete').val(d[0]['id_privilegio']);$('#privilegio_delete').val(d[0]['privilegio']);
                    $('#modal_delete').modal();
                    idDel = d[0]['id_privilegio'];
