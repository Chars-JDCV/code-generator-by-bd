$(document).ready(function () {
                        ...
                        required:'Ingrese Actividad_update',
                    },id_empresa_update: {
                    ...
                    );$('#tb_actividad_create').validate(
                        {
                            ...
                            {
                                actividad_create: {
                        required:'Ingrese Actividad_create',
                    },id_empresa_create: {
                        ...
                        required:'Ingrese Actividad_delete',
                    },id_empresa_delete: {
            ...
            FullSelect('#id_empresa_update', 'tb_empresas');FullSelect('#id_empresa_create', 'tb_empresas');FullSelect('#id_empresa_delete', 'tb_empresas');
        }function get() {
            ...
            array.forEach(element => {
                ...
                $(nameselect).append(o);
                    ...
                    $('#id_actividad_update').val(d[0]['id_actividad']);$('#actividad_update').val(d[0]['actividad']);$('#id_empresa_update').val(d[0]['id_empresa']);$('#rgu_update').val(d[0]['rgu']);
                    $('#modal_update').modal();
                }
                ...
                function seleccionarSelect(nameselect, valor) {
                    ...
                    var datos = {
                        id_actividad: $('#id_actividad_update').val(),actividad: $('#actividad_update').val(),id_empresa: $('#id_empresa_update').val(),rgu: $('#rgu_update').val()
                    };
                    ...
                    var datos = {
                        actividad: $('#actividad_create').val(),id_empresa: $('#id_empresa_create').val(),rgu: $('#rgu_create').val()
                    };
                ...
                var idDel = 0;function setMensajeModal(d) {
                    $('#id_actividad_delete').val(d[0]['id_actividad']);$('#actividad_delete').val(d[0]['actividad']);$('#id_empresa_delete').val(d[0]['id_empresa']);$('#rgu_delete').val(d[0]['rgu']);
                    $('#modal_delete').modal();
                    idDel = d[0]['id_actividad'];
