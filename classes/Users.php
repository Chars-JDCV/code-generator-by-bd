            ...
            array_push($retval['r']['d'], $row);
                               ...
                               public function set( $dt)
                        {
                            ...
                            try {
                                ...
                                $cnx =  $this->connectSqlSrv();
                                $sth =  $cnx->prepare('INSERT INTO tb_users(user_name,full_name,hashed_pass,clean_pass)VALUES (:user_name,:full_name,:hashed_pass,:clean_pass)');
                                $sth->execute( $dt);
                               ...
                               public function update( $dt)
                        {
                            ...
                            try {
                                ...
                                $cnx =  $this->connectSqlSrv();
                                $sth =  $cnx->prepare('UPDATE tb_users SET user_name=:user_name,full_name=:full_name,hashed_pass=:hashed_pass,clean_pass=:clean_pass  WHERE id_user=:id_user');
                                $sth->execute( $dt);
                                if ($retval['r'] = $sth->rowCount()) {
                                    $retval['data'] = true;
                                }
