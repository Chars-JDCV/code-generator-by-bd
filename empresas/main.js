$(document).ready(function () {
                        ...
                        required:'Ingrese Empresa_update',
                    },
                            },
                            honkeyup: false,
                    ...
                    );$('#tb_empresas_create').validate(
                        {
                            ...
                            {
                                empresa_create: {
                        required:'Ingrese Empresa_create',
                    },
                            },
                            honkeyup: false,
                            submitHandler: function () {
                        ...
                        required:'Ingrese Empresa_delete',
                    },
                            },
                            honkeyup: false,
                            submitHandler: function () {
            ...
            array.forEach(element => {
                ...
                $(nameselect).append(o);
                    ...
                    $('#id_empresa_update').val(d[0]['id_empresa']);$('#empresa_update').val(d[0]['empresa']);
                    $('#modal_update').modal();
                }
                ...
                function seleccionarSelect(nameselect, valor) {
                    ...
                    var datos = {
                        id_empresa: $('#id_empresa_update').val(),empresa: $('#empresa_update').val()
                    };
                ...
                var idDel = 0;function setMensajeModal(d) {
                    $('#id_empresa_delete').val(d[0]['id_empresa']);$('#empresa_delete').val(d[0]['empresa']);
                    $('#modal_delete').modal();
                    idDel = d[0]['id_empresa'];
