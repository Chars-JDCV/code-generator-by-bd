$(document).ready(function () {
                        $('#images_update').validate(
                        {
                            ...
                            {
                                id_update: {
                        required:'Ingrese Id_update',
                    },file_name_update: {
                        required:'Ingrese File_name_update',
                    },uploaded_on_update: {
                        required:'Seleccione Uploaded_on_update',
                    },status_update: {
                    ...
                    );$('#images_create').validate(
                        {
                            ...
                            {
                                file_name_create: {
                        required:'Ingrese File_name_create',
                    },uploaded_on_create: {
                        required:'Seleccione Uploaded_on_create',
                    },status_create: {
                    ...
                    );$('#images_delete').validate(
                        {
                            ...
                            {
                                id_delete: {
                        required:'Ingrese Id_delete',
                    },file_name_delete: {
                        required:'Ingrese File_name_delete',
                    },uploaded_on_delete: {
                        required:'Seleccione Uploaded_on_delete',
                    },status_delete: {
            ...
            array.forEach(element => {
                ...
                $(nameselect).append(o);
                    ...
                    $('#id_update').val(d[0]['id']);$('#file_name_update').val(d[0]['file_name']);$('#uploaded_on_update').val(d[0]['uploaded_on']);$('#status_update').val(d[0]['status']);
                    $('#modal_update').modal();
                }
                ...
                function seleccionarSelect(nameselect, valor) {
                    ...
                    var datos = {
                        id: $('#id_update').val(),file_name: $('#file_name_update').val(),uploaded_on: $('#uploaded_on_update').val(),status: $('#status_update').val()
                    };
                    ...
                    var datos = {
                        file_name: $('#file_name_create').val(),uploaded_on: $('#uploaded_on_create').val(),status: $('#status_create').val()
                    };
                ...
                var idDel = 0;function setMensajeModal(d) {
                    $('#id_delete').val(d[0]['id']);$('#file_name_delete').val(d[0]['file_name']);$('#uploaded_on_delete').val(d[0]['uploaded_on']);$('#status_delete').val(d[0]['status']);
                    $('#modal_delete').modal();
                    idDel = d[0]['id'];
